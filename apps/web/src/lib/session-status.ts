/**
 * 세션 상태 판단 유틸리티 (프론트엔드 SSOT)
 * 
 * 프론트엔드 전역에서 네이버 세션 상태를 판단할 때 이 함수들만 사용해야 합니다.
 * Settings / Schedules / Dashboard 어디서든 동일한 기준으로 상태를 판단합니다.
 * 
 * 주의: packages/core/src/utils/session-status.ts와 동기화되어야 합니다.
 */

// ============================================
// 상수 정의 (packages/core와 동일)
// ============================================

/** 세션 상태 (NaverSession.status) */
 ...
 * 
 * 이 함수는 프론트엔드 전역에서 세션이 글쓰기/스케줄 실행 등에
